...
namespace PizzaStoreV2.Models
{
    public class OrderTracker
    {
        ...
        public OrderTracker()
        { }
        public OrderTracker(int aPizzaID, int aOrderID, string aCusName, string aSizeName, bool aPeperoni, bool aMushrooms, bool aOnions, bool aSasuage, bool aBacon, bool aExtraCheese, bool aBlackOlives, bool aSpinach, bool aPineapple, float aPrice)
        {
